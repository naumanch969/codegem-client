                    ...
                    <div className={`flex flex-col justify-between gap-[1rem] w-full h-full`}>
                        {
                            sidebarLinks.map((item, index) => (
                                <Link
                                    ...
                                    className={`${route[1] == lowercase(item.name) && 'font-extrabold bg-dark-slate-blue-lighten text-teal-blue '} hover:bg-dark-slate-blue-lighten hover:text-white flex gap-[12px] py-[4px] px-[6px] w-full capitalize rounded-[4px] cursor-pointer `}
                                >
                                    {console.log(route[1] == lowercase(item.name), route[1], lowercase(item.name))}
                                    {
