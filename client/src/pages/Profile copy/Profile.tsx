...
import { Link, useParams } from 'react-router-dom'; // Use React Router's Link for navigation
import { ArrowDownward, SupervisedUserCircleRounded } from '@mui/icons-material';
