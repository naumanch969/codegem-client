...
export const BioModal = () => {
    ...
    const formSchema = z.object({ bio: z.string().min(1, { message: 'Bio is required.' }), })
    const initialData: z.infer<typeof formSchema> = { bio: '', }

    const form = useForm<z.infer<typeof formSchema>>({
        resolver: zodResolver(formSchema),
        defaultValues: { bio: loggedUser?.bio! },
    })
                    ...
                    <FormField
                        ...
                        render={({ field }: { field: any }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className='bg-secondary' placeholder='Let others know about you' {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
