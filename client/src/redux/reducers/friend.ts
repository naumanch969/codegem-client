...
const friendSlice = createSlice({
    ...
    reducers: {
        ...
        getFriendsReducer: (state, action: PayloadAction<User[]>) => {
...
export const { start, end, error, getSuggestedUsersReducer, getFriendsReducer, getReceivedRequestsReducer, getSentRequestsReducer, removeFriendRequestReducer, sendFriendRequestReducer, rejectFriendRequestReducer, acceptFriendRequestReducer, } = friendSlice.actions
